from .tumbler_base_config import LeggedRobotCfg, LeggedRobotCfgPPO


class Go2TumblerCfg(LeggedRobotCfg):
...
class Go2TumblerCfgPPO(LeggedRobotCfgPPO):
    runner_class_name = 'TumblerPolicyRunner'
